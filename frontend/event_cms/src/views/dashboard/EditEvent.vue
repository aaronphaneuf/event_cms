                ...
                <div class="box">
                    ...
                    <div class="table-container">
                        <table class="table is-fullwidth is-striped">
                            <thead>
                                <tr>
                                    <th>Price Layer<div class="form-group">
                                <button @click="addPriceType" type="button" class="button is-primary is-small">Add Time Slot</button>
                            </div></th>
                                    
                                        <th v-for="price in unique_prices">
                                        <div class="select">
                                            <select v-model="test.price_type">
                                                <option v-for="choice in all_pricetypes">{{choice.name}}</option>
                                            </select>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><div class="select">
                                            ...
                                            <select v-model="test.price_layer">
                                                    <option v-for="choice in all_pricelayers">{{choice.name}}</option>
                                                </select>
                                        
                                        </div></td>
                                    <td><input type="text" class="input" v-model="test.price"></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="input" v-model="asd"></td>
...
export default {
    ...
    methods: {
        ...
        async getEvent() {
            ...
            axios
                .get('api/v1/pricetype/')
                .then(response => {
                    this.all_pricetypes = response.data.reverse()
                })
                .catch(error => {
                    console.log(error)
                })
            ...
            axios
                .get('api/v1/pricelayer/')
                .then(response => {
                    this.all_pricelayers = response.data.reverse()
                })
                .catch(error => {
                    console.log(error)
                })
